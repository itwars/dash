...
func ProvideBackgroundServiceRegistry(
	...
	tracing *tracing.TracingService, remoteCache *remotecache.RemoteCache, alarmState *alarmstates.AlarmState,
	...
	_ *pluginsettings.Service, _ *alerting.AlertNotificationService, _ *microservice.Microservice, _ serviceaccounts.Service,
