...
func addDataSourceMigration(mg *Migrator) {
	...
	mg.AddMigration("Add unique index datasource_uid", NewAddIndexMigration(tableV2, &Index{
		Cols: []string{"uid"}, Type: UniqueIndex,
	}))

	mg.AddMigration("add unique index datasource_is_default", NewAddIndexMigration(tableV2, &Index{
		Cols: []string{"is_default"}}))
}
