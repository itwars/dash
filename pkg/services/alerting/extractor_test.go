...
func TestAlertRuleExtraction(t *testing.T) {
	...
	// mock data
	defaultDs := &models.DataSource{Id: 12, Name: "I am default", IsDefault: true, Uid: "def-uid"}
	graphite2Ds := &models.DataSource{Id: 15, Name: "graphite2", Uid: "graphite2-uid"}
	influxDBDs := &models.DataSource{Id: 16, Name: "InfluxDB", Uid: "InfluxDB-uid"}
	prom := &models.DataSource{Id: 17, Name: "Prometheus", Uid: "Prometheus-uid"}
