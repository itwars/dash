...
func BuildOptsFromFlags() BuildOpts {
	...
	flag.BoolVar(&opts.enterprise, "enterprise", false, "Build enterprise version of Dashboard")
	...
	flag.BoolVar(&opts.printGenVersion, "gen-version", false, "generate Dashboard version and output (default: false)")
	flag.Parse()
