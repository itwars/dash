...
function mapStateToProps(state: StoreState, props: OwnProps) {
  return {
    searchAlarmQuery: getSearchAlarmQuery(state.asset),
    userAlarmsCount: getUserAlarmsCount(state.asset),
...
export class UserAlarmList extends PureComponent<Props, any> {
  ...
  renderAlarm(alarm: UserAlarm) {
    ...
    const alarmUrl = `asset/useralarms/edit/${alarm.alarm_id}?alarm_level=${AlarmLevel.Asset}&site_id=${siteId}&asset_id=${assetId}`;
